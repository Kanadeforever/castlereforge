...
> 当前候选：v0.12.2 合成焦点与全输出鼠标修复候选；最新业务实机基线：v0.11-poc11。
> 本轮需配合 Controller v0.4.2 验证全部指针功能；Widescreen 单独运行仍只要求 Runtime。
> 测试命令见 tools/工具详细说明.md，精确地址与失败方案见 docs/Widescreen 完整接档。
