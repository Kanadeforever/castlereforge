...
// ============================================================================
// Castle_SaveEnhance.cpp  v0.3.0-test7 RuntimeSDK
// ----------------------------------------------------------------------------
...
static void InitializeVisuals(const CastleRuntimeApiV1* runtimeApi, CastlePluginHandle plugin) {
    ...
    options.slotTextWeight = static_cast<int>(ReadTomlS32("Visual", "SlotTextWeight", 0, -100, 200));
...
static CastleResult InitializeSaveEnhance(const CastleRuntimeApiV1* runtimeApi,
    ...
    ycrlog::Line("《幽城幻剑录》Castle_SaveEnhance v0.3.0-test7 RuntimeSDK 启动。");
...
static const char gSdkVersion[] = "0.3.0-test7";
