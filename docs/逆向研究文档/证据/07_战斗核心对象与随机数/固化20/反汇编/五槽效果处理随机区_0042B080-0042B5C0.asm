...
00401000 <.text>:
  42b080: 11 01                        	adc	dword ptr [ecx], eax
  42b082: 00 00                        	add	byte ptr [eax], al
  42b084: 75 0b                        	jne	0x42b091 <.text+0x2a091>
  ...
  42b0e6: 57                           	push	edi
  42b0e7: 0f 8f 9e 04 00 00            	jg	0x42b58b <.text+0x2a58b>
  ...
  42b124: 74 61                        	je	0x42b187 <.text+0x2a187>
  42b126: 8b 44 99 64                  	mov	eax, dword ptr [ecx + 4*ebx + 0x64]
  42b12a: 8b 54 99 78                  	mov	edx, dword ptr [ecx + 4*ebx + 0x78]
  42b12e: 3b c7                        	cmp	eax, edi
  42b130: 89 44 24 14                  	mov	dword ptr [esp + 0x14], eax
  42b134: 89 54 24 10                  	mov	dword ptr [esp + 0x10], edx
  42b138: 75 49                        	jne	0x42b183 <.text+0x2a183>
  42b13a: 3b ef                        	cmp	ebp, edi
  42b13c: 7e 45                        	jle	0x42b183 <.text+0x2a183>
  42b13e: 39 79 18                     	cmp	dword ptr [ecx + 0x18], edi
  42b141: 75 40                        	jne	0x42b183 <.text+0x2a183>
  42b143: 8d 04 ed 00 00 00 00         	lea	eax, [8*ebp]
  42b14a: 8b 0d b0 01 8a 00            	mov	ecx, dword ptr [0x8a01b0]
  42b150: 2b c5                        	sub	eax, ebp
  42b152: 8d 44 85 00                  	lea	eax, [ebp + 4*eax]
  42b156: c1 e0 04                     	shl	eax, 0x4
  42b159: 2b c5                        	sub	eax, ebp
  42b15b: d1 e0                        	shl	eax
  42b15d: 8d 54 98 50                  	lea	edx, [eax + 4*ebx + 0x50]
  42b161: 8d 44 98 64                  	lea	eax, [eax + 4*ebx + 0x64]
  42b165: 8b 14 0a                     	mov	edx, dword ptr [edx + ecx]
  42b168: 8b 0c 08                     	mov	ecx, dword ptr [eax + ecx]
  42b16b: 85 d2                        	test	edx, edx
  42b16d: 89 54 24 14                  	mov	dword ptr [esp + 0x14], edx
  42b171: 89 4c 24 10                  	mov	dword ptr [esp + 0x10], ecx
  42b175: 7e 0c                        	jle	0x42b183 <.text+0x2a183>
  42b177: c7 44 24 18 04 00 00 00      	mov	dword ptr [esp + 0x18], 0x4
  ...
  42b18d: 74 18                        	je	0x42b1a7 <.text+0x2a1a7>
  42b18f: 8b 94 98 e8 00 00 00         	mov	edx, dword ptr [eax + 4*ebx + 0xe8]
  42b196: 8b 84 98 fc 00 00 00         	mov	eax, dword ptr [eax + 4*ebx + 0xfc]
  ...
  42b20e: 0f 8e 80 00 00 00            	jle	0x42b294 <.text+0x2a294>
  42b214: 8b 4c 24 34                  	mov	ecx, dword ptr [esp + 0x34]
  42b218: 8b 81 90 00 00 00            	mov	eax, dword ptr [ecx + 0x90]
  42b21e: 8b 7c b1 64                  	mov	edi, dword ptr [ecx + 4*esi + 0x64]
  42b222: 85 c0                        	test	eax, eax
  42b224: 7e 20                        	jle	0x42b246 <.text+0x2a246>
  42b226: 8d 14 c5 00 00 00 00         	lea	edx, [8*eax]
  42b22d: 2b d0                        	sub	edx, eax
  42b22f: 8d 2c 90                     	lea	ebp, [eax + 4*edx]
  42b232: 8b 15 b0 01 8a 00            	mov	edx, dword ptr [0x8a01b0]
  42b238: c1 e5 04                     	shl	ebp, 0x4
  42b23b: 2b e8                        	sub	ebp, eax
  42b23d: 8d 04 6a                     	lea	eax, [edx + 2*ebp]
  42b240: 8b 6c b0 74                  	mov	ebp, dword ptr [eax + 4*esi + 0x74]
  42b244: eb 06                        	jmp	0x42b24c <.text+0x2a24c>
  42b246: 8b 15 b0 01 8a 00            	mov	edx, dword ptr [0x8a01b0]
  42b24c: 8b 81 94 00 00 00            	mov	eax, dword ptr [ecx + 0x94]
  42b252: 85 c0                        	test	eax, eax
  42b254: 7e 18                        	jle	0x42b26e <.text+0x2a26e>
  42b256: 8d 1c c5 00 00 00 00         	lea	ebx, [8*eax]
  42b25d: 2b d8                        	sub	ebx, eax
  42b25f: 8d 1c 98                     	lea	ebx, [eax + 4*ebx]
  42b262: c1 e3 04                     	shl	ebx, 0x4
  42b265: 2b d8                        	sub	ebx, eax
  42b267: 8d 04 5a                     	lea	eax, [edx + 2*ebx]
  42b26a: 8b 5c b0 74                  	mov	ebx, dword ptr [eax + 4*esi + 0x74]
  42b26e: 8b 81 98 00 00 00            	mov	eax, dword ptr [ecx + 0x98]
  42b274: 85 c0                        	test	eax, eax
  42b276: 7e 1c                        	jle	0x42b294 <.text+0x2a294>
  42b278: 8d 0c c5 00 00 00 00         	lea	ecx, [8*eax]
  42b27f: 2b c8                        	sub	ecx, eax
  42b281: 8d 0c 88                     	lea	ecx, [eax + 4*ecx]
  42b284: c1 e1 04                     	shl	ecx, 0x4
  42b287: 2b c8                        	sub	ecx, eax
  42b289: 8d 14 4a                     	lea	edx, [edx + 2*ecx]
  42b28c: 8b 44 b2 74                  	mov	eax, dword ptr [edx + 4*esi + 0x74]
  ...
  42b2bf: 7e 16                        	jle	0x42b2d7 <.text+0x2a2d7>
  42b2c1: 85 ff                        	test	edi, edi
  42b2c3: 7c 10                        	jl	0x42b2d5 <.text+0x2a2d5>
  42b2c5: 85 ed                        	test	ebp, ebp
  42b2c7: 7c 0c                        	jl	0x42b2d5 <.text+0x2a2d5>
  42b2c9: 85 db                        	test	ebx, ebx
  42b2cb: 7c 08                        	jl	0x42b2d5 <.text+0x2a2d5>
  42b2cd: 8b 44 24 1c                  	mov	eax, dword ptr [esp + 0x1c]
  42b2d1: 85 c0                        	test	eax, eax
  42b2d3: 7d 02                        	jge	0x42b2d7 <.text+0x2a2d7>
  ...
  42b30c: eb 05                        	jmp	0x42b313 <.text+0x2a313>
  42b30e: be 64 00 00 00               	mov	esi, 0x64
  42b313: 83 ff 1b                     	cmp	edi, 0x1b
  42b316: 7e 15                        	jle	0x42b32d <.text+0x2a32d>
  42b318: 8b 44 24 40                  	mov	eax, dword ptr [esp + 0x40]
  42b31c: 89 7c 98 10                  	mov	dword ptr [eax + 4*ebx + 0x10], edi
  42b320: c7 44 98 24 40 1f 00 00      	mov	dword ptr [eax + 4*ebx + 0x24], 0x1f40
  42b328: e9 50 02 00 00               	jmp	0x42b57d <.text+0x2a57d>
  42b32d: e8 33 62 02 00               	call	0x451565 <.text+0x50565>
  42b332: 99                           	cdq
  42b333: b9 64 00 00 00               	mov	ecx, 0x64
  42b338: f7 f9                        	idiv	ecx
  42b33a: 3b d6                        	cmp	edx, esi
  42b33c: 7c 0c                        	jl	0x42b34a <.text+0x2a34a>
  42b33e: 8a 44 24 44                  	mov	al, byte ptr [esp + 0x44]
  42b342: 84 c0                        	test	al, al
  42b344: 0f 84 33 02 00 00            	je	0x42b57d <.text+0x2a57d>
  ...
  42b359: 74 19                        	je	0x42b374 <.text+0x2a374>
  42b35b: 8b 02                        	mov	eax, dword ptr [edx]
  42b35d: 3d b7 01 00 00               	cmp	eax, 0x1b7
  42b362: 7c 10                        	jl	0x42b374 <.text+0x2a374>
  42b364: 3d be 01 00 00               	cmp	eax, 0x1be
  42b369: 7f 09                        	jg	0x42b374 <.text+0x2a374>
  ...
  42b378: 8b 35 b0 01 8a 00            	mov	esi, dword ptr [0x8a01b0]
  42b37e: 8b 82 90 00 00 00            	mov	eax, dword ptr [edx + 0x90]
  42b384: 85 c0                        	test	eax, eax
  42b386: 7e 17                        	jle	0x42b39f <.text+0x2a39f>
  42b388: 8d 2c c5 00 00 00 00         	lea	ebp, [8*eax]
  42b38f: 2b e8                        	sub	ebp, eax
  42b391: 8d 2c a8                     	lea	ebp, [eax + 4*ebp]
  42b394: c1 e5 04                     	shl	ebp, 0x4
  42b397: 2b e8                        	sub	ebp, eax
  42b399: 8b 44 6e 48                  	mov	eax, dword ptr [esi + 2*ebp + 0x48]
  42b39d: eb 02                        	jmp	0x42b3a1 <.text+0x2a3a1>
  ...
  42b3ab: 7e 17                        	jle	0x42b3c4 <.text+0x2a3c4>
  42b3ad: 8d 2c c5 00 00 00 00         	lea	ebp, [8*eax]
  42b3b4: 2b e8                        	sub	ebp, eax
  42b3b6: 8d 2c a8                     	lea	ebp, [eax + 4*ebp]
  42b3b9: c1 e5 04                     	shl	ebp, 0x4
  42b3bc: 2b e8                        	sub	ebp, eax
  42b3be: 8b 44 6e 48                  	mov	eax, dword ptr [esi + 2*ebp + 0x48]
  42b3c2: eb 02                        	jmp	0x42b3c6 <.text+0x2a3c6>
  ...
  42b44b: 7c 0d                        	jl	0x42b45a <.text+0x2a45a>
  42b44d: 83 f8 05                     	cmp	eax, 0x5
  42b450: 7f 08                        	jg	0x42b45a <.text+0x2a45a>
  42b452: 8b 54 24 34                  	mov	edx, dword ptr [esp + 0x34]
  42b456: 8b 6c 82 38                  	mov	ebp, dword ptr [edx + 4*eax + 0x38]
  42b45a: 83 ff 01                     	cmp	edi, 0x1
  42b45d: 7c 12                        	jl	0x42b471 <.text+0x2a471>
  42b45f: 83 ff 05                     	cmp	edi, 0x5
  42b462: 7f 0d                        	jg	0x42b471 <.text+0x2a471>
  42b464: 8b c5                        	mov	eax, ebp
  42b466: 8b 6c 24 30                  	mov	ebp, dword ptr [esp + 0x30]
  42b46a: 99                           	cdq
  42b46b: f7 7c bd 38                  	idiv	dword ptr [ebp + 4*edi + 0x38]
  42b46f: 8b e8                        	mov	ebp, eax
  42b471: 83 f9 01                     	cmp	ecx, 0x1
  42b474: 7c 29                        	jl	0x42b49f <.text+0x2a49f>
  42b476: 83 f9 0a                     	cmp	ecx, 0xa
  42b479: 7f 24                        	jg	0x42b49f <.text+0x2a49f>
  42b47b: 8b 44 24 34                  	mov	eax, dword ptr [esp + 0x34]
  42b47f: 8b 44 88 64                  	mov	eax, dword ptr [eax + 4*ecx + 0x64]
  42b483: 8d 04 80                     	lea	eax, [eax + 4*eax]
  42b486: 8d 0c 80                     	lea	ecx, [eax + 4*eax]
  ...
  42b4d8: 7d 04                        	jge	0x42b4de <.text+0x2a4de>
  42b4da: 33 c9                        	xor	ecx, ecx
  42b4dc: eb 24                        	jmp	0x42b502 <.text+0x2a502>
  42b4de: e8 82 60 02 00               	call	0x451565 <.text+0x50565>
  42b4e3: 99                           	cdq
  ...
  42b514: 89 54 9f 10                  	mov	dword ptr [edi + 4*ebx + 0x10], edx
  ...
  42b528: 89 54 9f 24                  	mov	dword ptr [edi + 4*ebx + 0x24], edx
  42b52c: 79 08                        	jns	0x42b536 <.text+0x2a536>
  42b52e: c7 44 9f 24 00 00 00 00      	mov	dword ptr [edi + 4*ebx + 0x24], 0x0
  42b536: 8b 4c 9f 10                  	mov	ecx, dword ptr [edi + 4*ebx + 0x10]
  42b53a: 8b 14 cd 68 a6 46 00         	mov	edx, dword ptr [8*ecx + 0x46a668]
  42b541: 85 d2                        	test	edx, edx
  42b543: 7c 24                        	jl	0x42b569 <.text+0x2a569>
  42b545: 8b 74 24 34                  	mov	esi, dword ptr [esp + 0x34]
  42b549: 8b 4c 9f 24                  	mov	ecx, dword ptr [edi + 4*ebx + 0x24]
  42b54d: 8b 84 96 e8 01 00 00         	mov	eax, dword ptr [esi + 4*edx + 0x1e8]
  42b554: 3b c1                        	cmp	eax, ecx
  42b556: 7e 0b                        	jle	0x42b563 <.text+0x2a563>
  42b558: 2b c1                        	sub	eax, ecx
  42b55a: 89 84 96 e8 01 00 00         	mov	dword ptr [esi + 4*edx + 0x1e8], eax
  42b561: eb 06                        	jmp	0x42b569 <.text+0x2a569>
  42b563: 2b c8                        	sub	ecx, eax
  42b565: 89 4c 9f 24                  	mov	dword ptr [edi + 4*ebx + 0x24], ecx
  42b569: 8b 44 9f 24                  	mov	eax, dword ptr [edi + 4*ebx + 0x24]
  42b56d: 85 c0                        	test	eax, eax
  42b56f: 7d 08                        	jge	0x42b579 <.text+0x2a579>
  42b571: c7 44 9f 24 00 00 00 00      	mov	dword ptr [edi + 4*ebx + 0x24], 0x0
  42b579: 8b 6c 24 20                  	mov	ebp, dword ptr [esp + 0x20]
  42b57d: 43                           	inc	ebx
  42b57e: 83 fb 05                     	cmp	ebx, 0x5
  42b581: 89 5c 24 18                  	mov	dword ptr [esp + 0x18], ebx
  42b585: 0f 8c 7d fb ff ff            	jl	0x42b108 <.text+0x2a108>
  42b58b: 5f                           	pop	edi
  42b58c: 5e                           	pop	esi
  42b58d: 5d                           	pop	ebp
  42b58e: 5b                           	pop	ebx
  42b58f: 83 c4 1c                     	add	esp, 0x1c
  42b592: c2 18 00                     	ret	0x18
  42b595: 90                           	nop
  42b596: 90                           	nop
  42b597: 90                           	nop
  42b598: 90                           	nop
