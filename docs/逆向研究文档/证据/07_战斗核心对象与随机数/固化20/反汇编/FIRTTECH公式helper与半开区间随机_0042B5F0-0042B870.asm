...
00401000 <.text>:
  ...
  42b5f9: 57                           	push	edi
  42b5fa: e8 81 04 00 00               	call	0x42ba80 <.text+0x2aa80>
  42b5ff: 8b d8                        	mov	ebx, eax
  42b601: 8b 44 24 14                  	mov	eax, dword ptr [esp + 0x14]
  42b605: 50                           	push	eax
  42b606: 8b ce                        	mov	ecx, esi
  42b608: e8 43 05 00 00               	call	0x42bb50 <.text+0x2ab50>
  ...
  42b617: e8 b4 06 00 00               	call	0x42bcd0 <.text+0x2acd0>
  ...
  42b639: 53                           	push	ebx
  42b63a: e8 41 04 00 00               	call	0x42ba80 <.text+0x2aa80>
  ...
  42b68c: 52                           	push	edx
  42b68d: e8 1e 16 00 00               	call	0x42ccb0 <.text+0x2bcb0>
  42b692: 8b 54 24 14                  	mov	edx, dword ptr [esp + 0x14]
  42b696: 8b cf                        	mov	ecx, edi
  42b698: 52                           	push	edx
  42b699: 03 f0                        	add	esi, eax
  42b69b: e8 b0 04 00 00               	call	0x42bb50 <.text+0x2ab50>
  ...
  42b6eb: e8 90 03 00 00               	call	0x42ba80 <.text+0x2aa80>
  ...
  42b71c: 52                           	push	edx
  42b71d: e8 8e 15 00 00               	call	0x42ccb0 <.text+0x2bcb0>
  42b722: 8b 54 24 18                  	mov	edx, dword ptr [esp + 0x18]
  42b726: 8b cf                        	mov	ecx, edi
  42b728: 52                           	push	edx
  42b729: 03 f0                        	add	esi, eax
  42b72b: e8 20 04 00 00               	call	0x42bb50 <.text+0x2ab50>
  ...
  42b759: 53                           	push	ebx
  42b75a: e8 21 03 00 00               	call	0x42ba80 <.text+0x2aa80>
  ...
  42b7a4: 52                           	push	edx
  42b7a5: e8 06 15 00 00               	call	0x42ccb0 <.text+0x2bcb0>
  42b7aa: 8b 54 24 14                  	mov	edx, dword ptr [esp + 0x14]
  42b7ae: 8b ce                        	mov	ecx, esi
  42b7b0: 52                           	push	edx
  42b7b1: 03 f8                        	add	edi, eax
  42b7b3: e8 98 03 00 00               	call	0x42bb50 <.text+0x2ab50>
  ...
  42b7d9: 53                           	push	ebx
  42b7da: e8 a1 02 00 00               	call	0x42ba80 <.text+0x2aa80>
  ...
  42b809: 52                           	push	edx
  42b80a: e8 a1 14 00 00               	call	0x42ccb0 <.text+0x2bcb0>
  42b80f: 8b 54 24 14                  	mov	edx, dword ptr [esp + 0x14]
  42b813: 8b cf                        	mov	ecx, edi
  42b815: 52                           	push	edx
  42b816: 03 f0                        	add	esi, eax
  42b818: e8 33 03 00 00               	call	0x42bb50 <.text+0x2ab50>
  42b81d: 99                           	cdq
  ...
  42b84e: 50                           	push	eax
  42b84f: 52                           	push	edx
  42b850: e8 9b fd ff ff               	call	0x42b5f0 <.text+0x2a5f0>
