; 固化42证据：DamageInfo大ID生成与normal pending排除
; 输入：当前用户RPG.exe.org解包样本；仅供静态复核，不修改EXE。
...
0042b2f0 <.text+0x2a2f0>:
  42b2f0:	d1 8b 7c 24 10 0f    	ror    DWORD PTR [ebx+0xf10247c],1
  42b2f6:	af                   	scas   eax,DWORD PTR es:[edi]
  42b2f7:	54                   	push   esp
  42b2f8:	24 28                	and    al,0x28
  ...
  42b33e:	8a 44            	mov    al,BYTE PTR [esp+0x44]
