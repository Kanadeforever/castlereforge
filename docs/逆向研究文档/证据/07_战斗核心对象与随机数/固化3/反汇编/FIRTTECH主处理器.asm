...
0042c680 <.text+0x2b680>:
  ...
  42cc93:	c2 14 00             	ret    0x14
  42cc96:	8b ff                	mov    edi,edi
  42cc98:	c8 c7 42 00          	enter  0x42c7,0x0
  42cc9c:	dc c7                	fadd   st(7),st
  42cc9e:	42                   	inc    edx
  42cc9f:	00 f0                	add    al,dh
  42cca1:	c7 42 00 04 c8 42 00 	mov    DWORD PTR [edx+0x0],0x42c804
  42cca8:	18 c8                	sbb    al,cl
  42ccaa:	42                   	inc    edx
  42ccab:	00 90 90 90 90 8b    	add    BYTE PTR [eax-0x746f6f70],dl
  42ccb1:	44                   	inc    esp
  42ccb2:	24 04                	and    al,0x4
