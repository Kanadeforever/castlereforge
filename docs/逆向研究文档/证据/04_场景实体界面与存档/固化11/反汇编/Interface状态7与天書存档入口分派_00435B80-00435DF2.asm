...
; objdump -D -Mintel --start-address=0x435b80 --stop-address=0x435df2 RPG.exe
...
00435b80 <.text+0x34b80>:
  435b80:	8b 88 fc 05 00 00    	mov    ecx,DWORD PTR [eax+0x5fc]
  435b86:	8a 81 79 05 00 00    	mov    al,BYTE PTR [ecx+0x579]
  435b8c:	84 c0                	test   al,al
  435b8e:	0f 85 16 01 00 00    	jne    0x435caa
  435b94:	8b 96 58 06 00 00    	mov    edx,DWORD PTR [esi+0x658]
  435b9a:	8b 82 a8 05 00 00    	mov    eax,DWORD PTR [edx+0x5a8]
  435ba0:	8a 88 79 05 00 00    	mov    cl,BYTE PTR [eax+0x579]
  435ba6:	84 c9                	test   cl,cl
  435ba8:	0f 85 fc 00 00 00    	jne    0x435caa
