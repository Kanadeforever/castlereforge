...
; objdump -D -Mintel --start-address=0x4245b0 --stop-address=0x424920 RPG.exe
...
004245b0 <.text+0x235b0>:
  ...
  42489e:	89 88 94 05 00 00    	mov    DWORD PTR [eax+0x594],ecx
  4248a4:	8b 96 ac 05 00 00    	mov    edx,DWORD PTR [esi+0x5ac]
  4248aa:	6a 48                	push   0x48
  4248ac:	88 5c 24 34          	mov    BYTE PTR [esp+0x34],bl
  4248b0:	c7 82 98 05 00 00 2c 	mov    DWORD PTR [edx+0x598],0x12c
  4248b7:	01 00 00 
  4248ba:	8b 86 ac 05 00 00    	mov    eax,DWORD PTR [esi+0x5ac]
  4248c0:	89 88 9c 05 00 00    	mov    DWORD PTR [eax+0x59c],ecx
  4248c6:	8b 8e ac 05 00 00    	mov    ecx,DWORD PTR [esi+0x5ac]
  4248cc:	c7 81 a0 05 00 00 f4 	mov    DWORD PTR [ecx+0x5a0],0x1f4
  4248d3:	01 00 00 
  4248d6:	8b 96 ac 05 00 00    	mov    edx,DWORD PTR [esi+0x5ac]
  4248dc:	88 9a 79 05 00 00    	mov    BYTE PTR [edx+0x579],bl
  4248e2:	e8 78 cd 02 00       	call   0x45165f
  4248e7:	83 c4 04             	add    esp,0x4
  4248ea:	89 44 24 0c          	mov    DWORD PTR [esp+0xc],eax
  4248ee:	3b c3                	cmp    eax,ebx
  4248f0:	c6 44 24 30 09       	mov    BYTE PTR [esp+0x30],0x9
  4248f5:	74 0e                	je     0x424905
  4248f7:	8d 4c 24 10          	lea    ecx,[esp+0x10]
  4248fb:	51                   	push   ecx
  4248fc:	8b c8                	mov    ecx,eax
  4248fe:	e8 dd c8 00 00       	call   0x4311e0
  424903:	eb 02                	jmp    0x424907
  424905:	33 c0                	xor    eax,eax
  424907:	8d 96 b4 05 00 00    	lea    edx,[esi+0x5b4]
  42490d:	8b c8                	mov    ecx,eax
  42490f:	52                   	push   edx
  424910:	53                   	push   ebx
  424911:	68 e0 01 00 00       	push   0x1e0
  424916:	68 80 02 00 00       	push   0x280
  42491b:	53                   	push   ebx
  42491c:	53                   	push   ebx
  42491d:	88 5c 24           	mov    BYTE PTR [esp+0x48],bl
