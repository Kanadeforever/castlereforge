...
0040d510 <.text+0xc510>:
  ...
  40d723:	89 44 24 0c          	mov    DWORD PTR [esp+0xc],eax
  40d727:	3b c7                	cmp    eax,edi
  40d729:	89 7c 24 7c          	mov    DWORD PTR [esp+0x7c],edi
  40d72d:	74 09                	je     0x40d738
  40d72f:	8b c8                	mov    ecx,eax
  40d731:	e8 3a 5e 00 00       	call   0x413570
  40d736:	eb 02                	jmp    0x40d73a
  40d738:	33 c0                	xor    eax,eax
  40d73a:	57                   	push   edi
  40d73b:	6a 10                	push   0x10
  40d73d:	c7 84 24 84 00 00 00 	mov    DWORD PTR [esp+0x84],0xffffffff
  40d744:	ff ff ff ff 
  40d748:	a3 cc fc 89 00       	mov    ds:0x89fccc,eax
  40d74d:	89 1d 18 f8 89 00    	mov    DWORD PTR ds:0x89f818,ebx
  40d753:	88 1d 1d f8 89 00    	mov    BYTE PTR ds:0x89f81d,bl
  40d759:	e8 c2 97 ff ff       	call   0x406f20
  40d75e:	8b 4c 24 7c          	mov    ecx,DWORD PTR [esp+0x7c]
  40d762:	83 c4 08             	add    esp,0x8
  40d765:	8b c6                	mov    eax,esi
  40d767:	64 89 0d 00 00 00 00 	mov    DWORD PTR fs:0x0,ecx
  40d76e:	5f                   	pop    edi
  40d76f:	5e                   	pop    esi
  40d770:	5b                   	pop    ebx
  40d771:	83 c4 74             	add    esp,0x74
  40d774:	c3                   	ret
