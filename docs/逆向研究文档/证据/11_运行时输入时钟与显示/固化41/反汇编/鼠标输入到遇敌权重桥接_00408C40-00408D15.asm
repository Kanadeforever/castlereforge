; 固化41：输入事件桥接到遇敌计数器
  ...
  408ccc:	09 00 00 
  408ccf:	7c 3e                	jl     0x408d0f
  408cd1:	a1 f0 8b 46 00       	mov    eax,ds:0x468bf0
  408cd6:	83 f8 03             	cmp    eax,0x3
  408cd9:	74 10                	je     0x408ceb
  408cdb:	83 f8 04             	cmp    eax,0x4
  408cde:	74 0b                	je     0x408ceb
  408ce0:	c7 05 f4 f7 89 00 00 	mov    DWORD PTR ds:0x89f7f4,0x0
  408ce7:	00 00 00 
