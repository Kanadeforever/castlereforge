...
00404a60 <.text+0x3a60>:
  ...
  404d3e:	90                   	nop
  404d3f:	90                   	nop
  404d40:	8b 44 24 08          	mov    eax,DWORD PTR [esp+0x8]
  404d44:	8b 54 24 04          	mov    edx,DWORD PTR [esp+0x4]
  404d48:	50                   	push   eax
  404d49:	52                   	push   edx
  404d4a:	e8 11 fd ff ff       	call   0x404a60
  404d4f:	84 c0                	test   al,al
  404d51:	75 17                	jne    0x404d6a
  404d53:	8d 44 24 08          	lea    eax,[esp+0x8]
  404d57:	68 d8 37 46 00       	push   0x4637d8
  404d5c:	50                   	push   eax
  404d5d:	c7 44 24 10 10 85 46 	mov    DWORD PTR [esp+0x10],0x468510
  404d64:	00 
  404d65:	e8 5d ce 04 00       	call   0x451bc7
