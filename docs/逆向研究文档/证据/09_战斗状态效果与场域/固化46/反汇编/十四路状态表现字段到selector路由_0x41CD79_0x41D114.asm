; 《幽城幻剑录》固化46证据：十四路Battle状态表现mux
; 来源：本轮RPG.exe.org提取RPG.exe；地址为PE VA。
; 用途：证明RoleDefinition字段 -> selector -> 14个child，以及15条direct call/14个逻辑槽的差异。
...
00401000 <.text>:
  ...
  41cd81: 7e 13                        	jle	0x41cd96 <.text+0x1bd96>
  ...
  41cdb1: eb 11                        	jmp	0x41cdc4 <.text+0x1bdc4>
  ...
  41cdc4: e8 27 19 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41cdc9: 8b 86 fc 01 00 00            	mov	eax, dword ptr [esi + 0x1fc]
  41cdcf: 85 c0                        	test	eax, eax
  41cdd1: 7e 13                        	jle	0x41cde6 <.text+0x1bde6>
  ...
  41ce01: eb 11                        	jmp	0x41ce14 <.text+0x1be14>
  ...
  41ce14: e8 d7 18 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41ce19: 8b 86 f4 01 00 00            	mov	eax, dword ptr [esi + 0x1f4]
  41ce1f: 85 c0                        	test	eax, eax
  41ce21: 7e 13                        	jle	0x41ce36 <.text+0x1be36>
  ...
  41ce51: eb 11                        	jmp	0x41ce64 <.text+0x1be64>
  ...
  41ce64: e8 87 18 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41ce69: 8b 86 f8 01 00 00            	mov	eax, dword ptr [esi + 0x1f8]
  41ce6f: 85 c0                        	test	eax, eax
  41ce71: 7e 13                        	jle	0x41ce86 <.text+0x1be86>
  ...
  41cea1: eb 11                        	jmp	0x41ceb4 <.text+0x1beb4>
  ...
  41ceb4: e8 37 18 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41ceb9: 8b 86 00 02 00 00            	mov	eax, dword ptr [esi + 0x200]
  41cebf: 85 c0                        	test	eax, eax
  41cec1: 7e 13                        	jle	0x41ced6 <.text+0x1bed6>
  ...
  41cef1: eb 11                        	jmp	0x41cf04 <.text+0x1bf04>
  ...
  41cf04: e8 e7 17 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41cf09: 8b 86 04 02 00 00            	mov	eax, dword ptr [esi + 0x204]
  41cf0f: 85 c0                        	test	eax, eax
  41cf11: 7e 13                        	jle	0x41cf26 <.text+0x1bf26>
  ...
  41cf41: eb 11                        	jmp	0x41cf54 <.text+0x1bf54>
  ...
  41cf54: e8 97 17 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41cf59: 8b 86 ec 01 00 00            	mov	eax, dword ptr [esi + 0x1ec]
  41cf5f: 85 c0                        	test	eax, eax
  41cf61: 7e 13                        	jle	0x41cf76 <.text+0x1bf76>
  ...
  41cf74: eb 11                        	jmp	0x41cf87 <.text+0x1bf87>
  ...
  41cf87: e8 64 17 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41cf8c: 8b 86 f0 01 00 00            	mov	eax, dword ptr [esi + 0x1f0]
  41cf92: 85 c0                        	test	eax, eax
  41cf94: 7e 13                        	jle	0x41cfa9 <.text+0x1bfa9>
  ...
  41cfa7: eb 11                        	jmp	0x41cfba <.text+0x1bfba>
  ...
  41cfba: e8 31 17 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41cfbf: 8b 86 24 02 00 00            	mov	eax, dword ptr [esi + 0x224]
  41cfc5: 85 c0                        	test	eax, eax
  41cfc7: 7e 13                        	jle	0x41cfdc <.text+0x1bfdc>
  ...
  41cff7: eb 11                        	jmp	0x41d00a <.text+0x1c00a>
  ...
  41d00a: e8 e1 16 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41d00f: 8b 86 14 02 00 00            	mov	eax, dword ptr [esi + 0x214]
  41d015: 85 c0                        	test	eax, eax
  41d017: 7e 13                        	jle	0x41d02c <.text+0x1c02c>
  ...
  41d02a: eb 11                        	jmp	0x41d03d <.text+0x1c03d>
  ...
  41d03d: e8 ae 16 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41d042: 8b 86 1c 02 00 00            	mov	eax, dword ptr [esi + 0x21c]
  41d048: 85 c0                        	test	eax, eax
  41d04a: 7e 13                        	jle	0x41d05f <.text+0x1c05f>
  ...
  41d05d: eb 11                        	jmp	0x41d070 <.text+0x1c070>
  ...
  41d070: e8 7b 16 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41d075: 8b 86 20 02 00 00            	mov	eax, dword ptr [esi + 0x220]
  41d07b: 85 c0                        	test	eax, eax
  41d07d: 7e 13                        	jle	0x41d092 <.text+0x1c092>
  ...
  41d090: eb 11                        	jmp	0x41d0a3 <.text+0x1c0a3>
  ...
  41d0a3: e8 48 16 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41d0a8: 8b 86 28 02 00 00            	mov	eax, dword ptr [esi + 0x228]
  41d0ae: 85 c0                        	test	eax, eax
  41d0b0: 7e 13                        	jle	0x41d0c5 <.text+0x1c0c5>
  ...
  41d0c3: eb 11                        	jmp	0x41d0d6 <.text+0x1c0d6>
  ...
  41d0d6: e8 15 16 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41d0db: 8b 86 0c 02 00 00            	mov	eax, dword ptr [esi + 0x20c]
  41d0e1: 85 c0                        	test	eax, eax
  41d0e3: 7e 1e                        	jle	0x41d103 <.text+0x1c103>
  ...
  41d0f6: e8 f5 15 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41d0fb: 5f                           	pop	edi
  41d0fc: 5e                           	pop	esi
  41d0fd: 5d                           	pop	ebp
  41d0fe: 5b                           	pop	ebx
  ...
  41d114: e8 d7 15 02 00               	call	0x43e6f0 <.text+0x3d6f0>
  41d119: 5f                           	pop	edi
  41d11a: 5e                           	pop	esi
  41d11b: 5d                           	pop	ebp
  41d11c: 5b                           	pop	ebx
