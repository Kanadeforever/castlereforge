...
0041cd60 <.text+0x1bd60>:
  41cd60:	00 8b 82 90 05 00    	add    BYTE PTR [ebx+0x59082],cl
  41cd66:	00 89 48 44 8b 8f    	add    BYTE PTR [ecx-0x7074bbb8],cl
  41cd6c:	c4 05 00 00 8b 91    	les    eax,FWORD PTR ds:0x918b0000
  41cd72:	94                   	xchg   esp,eax
  41cd73:	05 00 00 89 6a       	add    eax,0x6a890000
  41cd78:	44                   	inc    esp
