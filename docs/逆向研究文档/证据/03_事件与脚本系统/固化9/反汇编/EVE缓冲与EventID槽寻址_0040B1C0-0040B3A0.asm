...
0040b1c0 <.text+0xa1c0>:
  40b1c0:	a1 24 f8 89 00       	mov    eax,ds:0x89f824
  40b1c5:	85 c0                	test   eax,eax
  40b1c7:	74 13                	je     0x40b1dc
  40b1c9:	50                   	push   eax
  40b1ca:	e8 81 63 04 00       	call   0x451550
  40b1cf:	83 c4 04             	add    esp,0x4
  40b1d2:	c7 05 24 f8 89 00 00 	mov    DWORD PTR ds:0x89f824,0x0
  40b1d9:	00 00 00 
  40b1dc:	a1 20 f8 89 00       	mov    eax,ds:0x89f820
