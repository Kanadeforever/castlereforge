...
0040f090 <.text+0xe090>:
  40f090:	bd ff ff 8b c8       	mov    ebp,0xc88bffff
  ...
  40f14b:	88 1d 1e f8 89 00    	mov    BYTE PTR ds:0x89f81e,bl
  40f151:	88 1d 1d f8 89 00    	mov    BYTE PTR ds:0x89f81d,bl
  40f157:	e8 f4 23 04 00       	call   0x451550
  40f15c:	83 c4 04             	add    esp,0x4
  40f15f:	33 c0                	xor    eax,eax
  40f161:	5b                   	pop    ebx
  40f162:	5e                   	pop    esi
  40f163:	59                   	pop    ecx
  40f164:	c3                   	ret
