  ...
  40375b:	89 15 14 f6 46 00    	mov    DWORD PTR ds:0x46f614,edx
  403761:	38 1d 24 f6 46 00    	cmp    BYTE PTR ds:0x46f624,bl
  403767:	74 6e                	je     0x4037d7
  403769:	8d 54 24 08          	lea    edx,[esp+0x8]
  40376d:	6a 01                	push   0x1
  40376f:	52                   	push   edx
  403770:	68 70 84 46 00       	push   0x468470
  403775:	e8 36 ee ff ff       	call   0x4025b0
  40377a:	e8 91 54 00 00       	call   0x408c10
  40377f:	8b 70 10             	mov    esi,DWORD PTR [eax+0x10]
  403782:	e8 89 54 00 00       	call   0x408c10
  403787:	8b 48 14             	mov    ecx,DWORD PTR [eax+0x14]
